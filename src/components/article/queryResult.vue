<template>
  <div id="query_result">
    <div v-for="(item, index) in queryResultList"  :key="index" class="mid_Body_list" :ref="`mid_Body_list${index}`">
...
export default {
    ...
    created() {
        ...
        // console.log('=====---')
        console.log(this.props.queryResultList)
