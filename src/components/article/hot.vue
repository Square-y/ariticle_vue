<template>
  <div id="hot">
    <div v-for="(item, index) in hotessayList"  :key="index" class="mid_Body_list" :ref="`mid_Body_list${index}`">
      <div class="title" @mouseenter="titleenter(index)" @mouseleave="titleleave(index)" :ref="`title${index}`">{{ item.title }} </div>
        ...
        <div class="briefly_no_image"  @mouseenter="brieflyenter(index)" @mouseleave="brieflyleave(index)" :style="active" :ref="`briefly${index}`" v-html="item.introduce"></div>
      </div>
      ...
      <div v-else class="article_tag" @click="article_tagclick(index)" :ref="`article_tag${index}`" >
        ...
        <div class="briefly"  @mouseenter="brieflyenter(index)" @mouseleave="brieflyleave(index)" :style="active" :ref="`briefly${index}`" v-html="item.introduce"></div>
      </div>
      ...
      <div class="article_info" :ref="`article_info${index}`">
        <div>
          ...
          <div class="author" @mouseenter="authorEnter(index)" @mouseleave="authorLeave(index)" :ref="`author${index}`">{{ item.author }}</div>
        </div>
...
export default {
    ...
    created () {  
      ...
      this.$request({
        ...
        console.log('|||||||--hot')
        this.hotessayList = res.data.info;
        console.log(this.hotessayList);
        return this.hotessayList
      }).catch(err=>{
        this.hotessayList = err;
      })
    },
}
</script>
